...
async function run() {
  ...
  const res = await client.query('SELECT a."contentJson" FROM "Article" a JOIN "Revision" r ON a."revisionId" = r.id JOIN "Rule" ru ON r."ruleId" = ru.id WHERE ru."ruleNumber" = \'2-0-2\' AND a."articleNumber" = 3');
