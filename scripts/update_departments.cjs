...
const DEPARTMENTS = [
  ...
  // 교무지원처 (구 교학지원처)
  { name: '교무지원처', code: 'ACADEMIC', sortOrder: 30, parentCode: null },
  { name: '대학원', code: 'GRADUATE', sortOrder: 31, parentCode: 'ACADEMIC' },
  // 기획조정처
  { name: '기획조정처', code: 'PLANNING', sortOrder: 40, parentCode: null },
  { name: '정보도서관', code: 'LIBRARY', sortOrder: 41, parentCode: 'PLANNING' },
  // 입학지원처 (구 입학홍보처)
  { name: '입학지원처', code: 'ADMISSIONS', sortOrder: 50, parentCode: null },
  // 행정지원처
  { name: '행정지원처', code: 'ADMIN', sortOrder: 60, parentCode: null },
  // 산학협력단
