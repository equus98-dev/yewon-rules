...
var BuildId = "pdsTjdyoYQo62uSb-1i65";
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/_global-error/page": "/_global-error", "/api/admin/rules/[id]/route": "/api/admin/rules/[id]", "/icon.png/route": "/icon.png", "/api/admin/articles/[id]/route": "/api/admin/articles/[id]", "/api/admin/files/route": "/api/admin/files", "/api/admin/revisions/route": "/api/admin/revisions", "/api/admin/stats/route": "/api/admin/stats", "/api/admin/rules/route": "/api/admin/rules", "/api/attachments/route": "/api/attachments", "/api/download/route": "/api/download", "/api/categories/route": "/api/categories", "/api/files/[key]/route": "/api/files/[key]", "/api/notices/route": "/api/notices", "/api/ping-db/route": "/api/ping-db", "/api/ping/route": "/api/ping", "/api/rules/[id]/route": "/api/rules/[id]", "/api/rules/search/route": "/api/rules/search", "/page": "/", "/admin/editor/page": "/admin/editor", "/admin/files/page": "/admin/files", "/admin/login/page": "/admin/login", "/admin/notices/page": "/admin/notices", "/admin/page": "/admin", "/admin/rules/[id]/edit/page": "/admin/rules/[id]/edit", "/admin/rules/page": "/admin/rules" };
