...
- 항(①, ②)과 호(1., 2.)는 줄바꿈(\\n)으로 명확히 구분되도록 해주세요.
- **매우 중요**: 만약 규정 본문 내용 중에 표(Table)나 별지 서식 등 표 형태의 데이터가 포함되어 있다면, 그 내용을 절대로 생략하거나 단순 텍스트로 뭉개지 말고, 반드시 HTML <table>, <tr>, <th>, <td> 태그를 사용하여 원본 표의 형태와 데이터를 완벽하게 유지한 채 contentText 문자열 안에 포함시켜 주세요.
