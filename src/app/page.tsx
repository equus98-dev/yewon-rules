            ...
            <div className="flex-1 flex flex-col overflow-y-auto scrollbar bg-slate-50 relative">
              <div className="max-w-[1400px] w-full mx-auto p-6 md:p-8 flex flex-col gap-8 min-h-0">
                ...
                <div className="w-full mt-1.5 mb-2">
                  <div className="flex bg-emerald-50/70 border border-emerald-100/60 rounded-lg overflow-hidden h-[45px] items-center px-4 relative">
                    ...
                    <div className="flex-1 overflow-hidden relative h-full flex items-center mx-4" style={{ maskImage: 'linear-gradient(to right, transparent, black 2%, black 98%, transparent)' }}>
                      <div className="flex animate-marquee gap-12 md:gap-20 items-center w-max">
                        ...
                        <a href="https://www.yewon.ac.kr/" target="_blank" className="shrink-0">
                           <img src="/docs/UI.png" alt="예원예술대학교" className="mix-blend-multiply object-contain h-7 w-auto grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all" />
                        </a>
                        <a href="https://www.law.go.kr/main.html" target="_blank" className="shrink-0">
                           <img src="/docs/h_logo1.png" alt="국가법령정보센터" className="mix-blend-multiply object-contain h-7 w-auto grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all" />
                        </a>
                        <a href="https://www.moe.go.kr/main.do?s=moe" target="_blank" className="shrink-0">
                           <img src="/docs/kyo.png" alt="교육부" className="mix-blend-multiply object-contain h-7 w-auto grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all" />
                        </a>
                        <a href="https://www.moleg.go.kr/index.es?sid=a1" target="_blank" className="shrink-0">
                           <img src="/docs/rru.png" alt="법제처" className="mix-blend-multiply object-contain h-6 w-auto grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all" />
                        </a>
                        <a href="https://www.scourt.go.kr/scourt/index.html" target="_blank" className="shrink-0">
                           <img src="/docs/logo333.png" alt="법원" className="mix-blend-multiply object-contain h-10 w-auto grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all scale-110" />
                        </a>
                        {/* 복제 세트 (무한 롤링용) */}
                        <a href="https://www.yewon.ac.kr/" target="_blank" className="shrink-0">
                           <img src="/docs/UI.png" alt="예원예술대학교" className="mix-blend-multiply object-contain h-7 w-auto grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all" />
